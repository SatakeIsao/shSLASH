...
namespace nsK2EngineLow {
    ...
    void Sprite::InitTextures(const SpriteInitData& initData)
    {
        ...
        if (initData.m_ddsFilePath[0] != nullptr) {
            ...
            // テクスチャが指定されていない。
            MessageBoxA(nullptr, "initData.m_ddsFilePath か m_textures のどちらかに使用するテクスチャの情報を設定してください。", "エラー", MB_OK);
            std::abort();
        }
    }
